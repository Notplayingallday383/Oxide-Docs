...
# TerbiumOS
This is webos packed full of features with a sleek gnome like design
...
**NOTE** More Services are supported such as Render, and Netlify however there is not a quick url at this time also keep in mind that on Glitch and Replit Proxies are banned. Refer to [this document](guides/deployment-restirctions) to view ways to curcomvent this
...
If you wish to make a contribution feel free to create a pull request!

TerbiumOS is licensed under the Apache 2.0 License
